...
namespace Troya
{
    public struct OrientedBoundingBox : IEquatable<OrientedBoundingBox>
    {
        ...
        public OrientedBoundingBox( Vector3 center, Vector3 halfExtents ) {
            this.Center = center;
        ...
        public BoundingBox ConvertToBoundingBox( ) {
            Vector3 min = ( this.Center - this.HalfExtent );
            Vector3 max = ( this.Center + this.HalfExtent );
